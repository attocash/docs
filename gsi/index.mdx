...
import MetricsProvider from "@site/src/components/MetricsProvider";

# Growth Stability Index

<MetricsProvider>

The Growth Stability Index (GSI) dynamically adjusts Atto's distribution rate based on market conditions. The current GSI is **<Metric name="distribution.growth-stability-index" />**, meaning distribution rates are adjusted to this factor. It balances widespread token distribution with price stability, ensuring Atto remains practical as digital cash.
