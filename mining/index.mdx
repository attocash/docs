...
The system periodically checks Folding@Home scores—about **twice per day**, although the exact timing may vary.
...
* If 12 hours (720 minutes) have passed, then `5,000 × 720 = 3,600,000 attos` are distributed in that cycle.
