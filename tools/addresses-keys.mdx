---
title: Atto Address Validator and Demo Key Tools
sidebar_label: Addresses & Demo Keys
...
Convert a public key to an Atto address, decode an address and check its checksum, or study key derivation with disposable demo values. To create a wallet you intend to fund, use the [Atto wallet](/wallet).
