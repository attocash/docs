...
title: Atto Node Setup — Roles and Requirements
description: Choose an Atto historical or voter node, review hardware, database and network requirements, then deploy with Docker Compose or Kubernetes.
---

# Atto node setup {#node}
...
To participate in staking rewards as well, check the [reward eligibility rules](/docs/staking). Running the node and receiving delegated weight do not automatically enroll it in the reward programme.
...
Derivation](/docs/integration/advanced/offline-signing-with-atto-commons#key-generation-and-derivation) in the advanced
Commons integration guide provides an example for generating a seed phrase mnemonic, a private key and a matching
