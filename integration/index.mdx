...
* **Instant confirmations:** ~<Metric name="network.confirmation-time.ms.seven-day-p50" />ms.
...
|---------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Send & receive transactions** | [`historical node`](/docs/integration/node#historical-node), [`wallet‑server`](/docs/integration/wallet-server), [`work‑server`](/docs/integration/work-server) |
| **Participate in consensus**    | [`voter node`](/docs/integration/node#voter-node) + optional [`signer`](/docs/integration/signer)                                         |
| **Run analytics**               | [`historical node`](/docs/integration/node#historical-node)                                                                                                   |
| **Check things out**            | [`historical node`](/docs/integration/node#historical-node)                                                                                                   |
