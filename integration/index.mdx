...
|---------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Send & receive transactions** | [`historical node`](/docs/integration/node#historical-node-configuration), [`wallet‑server`](/docs/integration/wallet-server), [`work‑server`](/docs/integration/work-server) |
| **Participate in consensus**    | [`voter node`](/docs/integration/node#voter-node-configuration) + optional [`signer`](/docs/integration/signer)                                                               |
| **Run analytics**               | [`historical node`](/docs/integration/node#historical-node-configuration)                                                                                                     |
| **Check things out**            | [`historical node`](/docs/integration/node#historical-node-configuration)                                                                                                     |
