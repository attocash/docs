...
<Tabs groupId="library">
  ...
  <TabItem value="kotlin" label="Kotlin">
    ...
    val transactionMonitor = accountMonitor.toTransactionMonitor { 1U.toAttoHeight() }

    val accountEntryMonitor = accountMonitor.toAccountEntryMonitor { 1U.toAttoHeight() }
